...
API_TOKEN = '7440048294:AAEtp8BJwXoWRCwK3tWXH7aNcc'
ADMIN_IDS = [6300239995, 5195444280]
ADMIN_USERNAME = '@ITS_PANDAX_09'
...
def buy_prepaid_ig(message):
    ...
    markup.add(types.KeyboardButton('BACK'))
    bot.send_message(message.chat.id, "PRICE PER PREPAID IG IS :- ₹50\n\nIF YOU WANT TO LEARN ABOUT GUARANTEE THEN DM @ITS_PANDAX_09", reply_markup=markup)
